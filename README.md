...
- 🌱 Learning Autoencoders, self-supervised learning, optimization, time series analysis using deep learning, Linear programming, Anomaly detection 
